...
couponRouter.get('/get-all-coupons/:id', isStoreAuthenticated, catchAsync(async (req, res, next) => {
    try {
...
couponRouter.delete('/delete-coupon/:id', isStoreAuthenticated, catchAsync(async (req, res, next) => {
    try {
...
couponRouter.get("/get-coupon-value", catchAsync(async (req, res, next) => {
    try {
        // TODO: validate and sanitize inputs
        const { code } = req.body;
...
couponRouter.get('/coupon-apply', catchAsync(async (req, res, next) => {
    try {
        // TODO: validate and sanitize inputs

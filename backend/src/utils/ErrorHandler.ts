...
export const createAuthError = (message = "Authentication Error") =>
    new ErrorHandler(401, message);

export const createDataBaseError = (message = "Database Error") => 
    new ErrorHandler(500, message);

export const createvalidateError = (message = "Validation Error") =>
    new ErrorHandler(400, message);

export const createNotFoundError = (message = "Not Found Error") =>
    new ErrorHandler(404, message);

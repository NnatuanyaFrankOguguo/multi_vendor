...
const ProfileContent = ({active}) => {
    ...
    //     e.preventDefault()
    //     try {
    //         await axios.delete(`${server}/api/users/delete-user/${user._id}`, {withCredentials: true})
        ...
        <div className='pl-8 pt-1'>

            {
                ...
                <div className="text-center mt-4">
                    ...
                    <div className='w-full max-w-full ' style={{ height: "auto" }}>
        ...
        <div className='pl-8 pt-1'>

            {
                ...
                <div className="text-center mt-4">
                    ...
                    <div className='' style={{ height: "auto", minWidth: "auto" }}>
    ...
    return (
        <div className="w-full px-5">
            ...
            <div className="flex flex-wrap items-center justify-between">
                ...
                <div
                    className={`${styles.button} flex items-center justify-center w-[100px] h-[40px] rounded-[5px] cursor-pointer`}
                >
                    <span className="text-[#fff] text-sm md:text-base">
                        Add New {/* Popup for "Add New" will be added later */}
                    </span>
                </div>
            </div>
            <br />
            ...
            <div className="w-full bg-white h-auto md:h-[70px] rounded-[4px] flex flex-wrap items-center px-3 shadow justify-between md:pr-10 gap-4">
                ...
                <div className="flex items-center w-full md:w-auto">
                    <img
                        src="https://cdn.freebiesupply.com/images/large/2x/mastercard-logo-png-transparent.png"
                        alt="mastercard"
                        className="w-[40px] md:w-[50px]"
                    />

                    <h3 className="pl-4 font-[600] text-sm md:text-base">
                        Nnatuanya Frank
                    </h3>
                </div>
                ...
                <div className="flex items-center w-full md:w-auto md:pl-8 text-sm md:text-base">
                    <h6>1234 **** **** ****</h6>
                    <h5 className="pl-4 md:pl-6">08/2026</h5>
                </div>

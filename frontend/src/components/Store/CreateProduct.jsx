  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-y-scroll" style={{
      ...
      <div className='w-[90%] max-w-md md:max-w-lg lg:max-w-xl h-[80vh] rounded-[4px] p-3  '>
          ...
          <h2 className='text-2xl font-semibold font-Poppins text-center mb-6'>Create Product</h2>
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div>
                <label className='block text-gray-700'>Weight (kg) <span className='text-red-500'>*</span></label>
                <input type='number' value={weight} onChange={(e) => setWeight(e.target.value)}
                  className='mt-1 w-full border rounded-md px-3 py-2 focus:ring-yellow-500 focus:border-yellow-500' placeholder='Please enter the weight for delivery and storage' />
              </div>
              <div>

const styles = {
    ...
    active_indicator: "absolute bottom-[-27%] left-0 b-[3px] w-full bg-[crimson]",
    button: "w-[150px] bg-block b-[50px] my-3 flex items-center justify-center rounded-xl curser-pointer",
    ...
    activeStatus: "w-[10px] h-[10px] bg-[#4bd132] absolute top-0 right-1 rounded-full",  
